/* ============================================================
 * characters.js —— 角色数据包（小程序移植版）
 * 数据原样移植自 mood-mates 的 src/characters/{nimbo,twinkle}.js
 * (github.com/sam70361/aora-bot，社区许可：个人学习研究免费)
 *
 * 一个角色 = 一个纯数据文件；引擎加载时逐个 register。
 * ============================================================ */
...
var NIMBO = {
  ...
  emotions: {
    ...
    '33': {
      desc: '椭圆眼弯弯，腮红浅浅浮上来',
      en: { name: 'Done', desc: 'Oval smiling eyes and a light blush' },
      pool: ['happy', 'happy2'],
      mouth: 'grin',
