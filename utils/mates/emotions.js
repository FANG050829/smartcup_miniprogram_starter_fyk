/* ============================================================
 * emotions.js —— 表情数据基座（小程序移植版，纯数据）
 * 原样移植自 mood-mates 的 src/data/emotions.js
 * (github.com/sam70361/aora-bot，社区许可：个人学习研究免费)
 *
...
var EMOTION_SEED = [
...

  {
    ...
    desc: '椭圆眼 + 浅浅微笑，腮红微微浮起，身体轻快起伏',
    en: { name: 'Happy', desc: 'Oval eyes with a soft little smile and light blush, body bouncing lightly' },
    transition: 380,
    pool: ['happy', 'happy2'], poolMs: [2500, 4500], blinkMs: [2500, 5000], antics: true,
    /* 应用侧调整：咧嘴 grin 观感偏怪，改为浅笑弧 + 轻腮红 */
    mouth: 'smile',
  ...
  },
  {
    ...
    desc: '椭圆笑眼咧嘴 + 自旋甩出一圈粒子 + 撒花庆祝',
    en: { name: 'Done', desc: 'Oval eyes and a grin, a celebratory particle spin and a burst of confetti' },
    transition: 240,
...
module.exports = { GROUPS: EMOTION_GROUPS, SEED: EMOTION_SEED };
