/* ============================================================
 * emotions.js —— 数据层（纯数据）
 * 来源：开源项目 emotion-ball (github.com/sam70361/emotion-ball)
 * 授权：表情配置数据双许可，个人学习研究免费
 * 小程序移植：window 挂载改为 CommonJS 导出
 * ID 分段：00-09 生命周期 · 10-29 情绪 · 30-49 代理状态 · 50+ 自定义
 * ============================================================ */
/* ============================================================
...
var SEED = [
...

  {
    ...
    body: { y: 4, rotate: -2, breathe: 0.018, color: '#FFFFFF', zzz: 1 },
  ...
  },
  {
    ...
    body: { y: 6, scale: 0.98, rotate: -1, breathe: 0.005, color: '#FFFFFF' },
    eyes: { both: { y: 5 } }
  },
  {
...

  {
    ...
    body: { y: -3, breathe: 0.014, color: '#FFFFFF' },
    eyes: { both: { y: -3 } },
    anims: [
  ...
  },
  {
    ...
    body: { y: 5, rotate: -4, breathe: 0.007, color: '#FFFFFF' },
  ...
  },
  {
    ...
    /* base 色 = 序列终态粉：害羞粉是纯白规则外唯一保留的体色特例 */
  ...
  },
  {
    ...
    body: { y: 4, rotate: -3, breathe: 0.016, color: '#FFFFFF' },
  ...
  },
  {
    ...
    body: { breathe: 0.012, color: '#FFFFFF' },
    anims: [
  ...
  },
  {
    ...
    sequence: {
      ...
      frames: [
        ...
        { at: 170, body: { color: '#FFFFFF', rotate: -4 } },
        { at: 340, body: { color: '#E25B5B', rotate: -7 } },
        { at: 510, body: { color: '#FFFFFF', rotate: -5 } },
  ...
  },
  {
    ...
    body: { y: 2, rotate: -2, color: '#FFFFFF' },
  ...
  },
  {
    ...
    body: { y: 3, breathe: 0.004, color: '#FFFFFF' },
    sequence: {
      settle: 'hold',
      frames: [
        { at: 0 },
...
module.exports = { GROUPS: GROUPS, SEED: SEED };
